...
flowchart TD
  ...
  S83["Тесты, git init, коммит"]
  S82 -->|"файл обновлён"| S83
  S84["Remote и токен GitHub"]
  S83 -->|"ba8ccd4 Граф решений +…"| S84
  S85["Push в origin main"]
  S84 -->|"--- git credential helper:…"| S85
  S86{{"T: агенты: краевые случаи… ✓"}}:::decisionDone
  S85 -->|"a453623..ba8ccd4 main - main"| S86
  S87["Подписи стрелок в живой…"]
  S86 -->|"правка внесена"| S87
```
